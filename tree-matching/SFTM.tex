...
\begin{keyword}
Web \sep Tree~matching \sep Information~Extraction
\end{keyword}
...
\begin{figure}
    \centering
	\includegraphics[width=.65\linewidth]{explanation/rted_mistake}
...
\begin{figure}
    \centering 
    \includegraphics[width=.5\textwidth]{explanation/g_ftm}
...
\begin{figure*}
    \centering
	\includegraphics[width=\linewidth]{explanation/ftm-sftm-steps}
...
\begin{figure*}
    \centering
    \includegraphics[width=\linewidth]{inverted_index}
...
\begin{figure}
    \centering
    \includegraphics[width=.6\linewidth]{graphs/distribution_size}
...
\begin{figure}
  \centering
  \includegraphics[width=.65\linewidth]{graphs/f1score}
...
\begin{figure}%{\textwidth}
    \centering
    \includegraphics[width=.85\linewidth]{graphs/computationTime}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{graphs/efficiency}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{graphs/sensitivity}
