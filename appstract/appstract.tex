...
%\title{Appstract: Towards the ultimate locator for web Applications}
% \title{Handling webpage variability to infer an application's model}
% \title{Appstract: Inferring Canonical Locators Spanning~Across Pages of a Web~App}
% \title{Appstract: Inferring Spanning Locators for Web~App Pages}
\title{\textsc{Appstract}: Inferring Application-wide Locators for the Web}
...
\begin{figure*}[ht]
  ...
  \hspace{.1\textwidth}
  \begin{subfigure}{.35\textwidth}
    \includegraphics[width=\linewidth]{amazon_b.png}
