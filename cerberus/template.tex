...
\lstdefinelanguage{HTML5}{
        ...
        otherkeywords={
        % HTML tags
        <html>, <head>, <title>, </title>, <meta, />, </head>, <body>, <form, <input, <button, </button>, 
        ...
        =,
        % HTML attributes
        charset=, id=, width=, height=, method=, action=, type=, name=, value=, data-cerberus=,
        % CSS properties
...
% \title{Repairing Broken~Web~Locators in~the~Wild: An~Experience~Report}
\title{Deploying Robust~Web~Locators in~the~Wild: An~Experience~Report}
% \author{Submission \#356 (10+1~pages)}
\author{
    \IEEEauthorblockN{\bf \emph{Sacha}~\textsc{Brisset}}
    \IEEEauthorblockA{Mantu / Inria}
    \and
    \IEEEauthorblockN{\bf \emph{Antoine}~\textsc{Craske}\\\emph{Benoit}~\textsc{Dumont}}
    \IEEEauthorblockA{La\,Redoute}
    % \and
    % \IEEEauthorblockN{\emph{Benoit}~\textsc{Dumont}}
    % \IEEEauthorblockA{La Redoute}
    \and
    \IEEEauthorblockN{\bf \emph{Romain}~\textsc{Rouvoy}\\\emph{Lionel}~\textsc{Seinturier}}
    \IEEEauthorblockA{Univ.\,Lille / Inria / IUF}
    % \and
    % \IEEEauthorblockN{\emph{Lionel}~\textsc{Seinturier}}
    % \IEEEauthorblockA{Univ. Lille / Inria}
    \and
    \IEEEauthorblockN{\bf \emph{Renaud}~\textsc{Pawlak}}
    \IEEEauthorblockA{Cinchéo}
}
...
\begin{figure*}[]
    \centering
    \includegraphics[width=.85\linewidth]{explanations/cerberus}
...
\begin{figure*}[htbp]
    \centering
    \includegraphics[width=.7\linewidth]{explanations/erratum_as_locator}
